...
KW_LIST['kwa'] = '''aaa aad aam aas adc add and arpl bound bsf bsr bswap bt btc btr bts call cbw cdq clc 
...
KW_LIST['kwb'] = '''ah al and ax bh bl bp bx byte ch cl cs cx dh di dl ds dword dx eax ebp ebx ecx edi edx
