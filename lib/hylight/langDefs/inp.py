...
KW_LIST['kwa'] = '''abort accelerator access alias almon append area arguments
...
KW_LIST['kwb'] = '''accept activate adjust apply argument associate attribute backto best
