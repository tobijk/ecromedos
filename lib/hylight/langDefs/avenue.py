...
KW_LIST['kwa'] = '''break continue CR each end exit false for if in nil NL return TAB then true while
...
KW_LIST['kwb'] = '''AddressStyle Albers Annotation Application AreaOfInterestDialog AttrRange AttrSingle AttrUpdate AutoLabelDialog AV Axis
