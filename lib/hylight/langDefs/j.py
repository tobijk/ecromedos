...
KW_LIST['kwa'] = '''catch class end field implements interface limit line method source
...
KW_LIST['kwb'] = '''abstract default final from is lookupswitch native private protected
