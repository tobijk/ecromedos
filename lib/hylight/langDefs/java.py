...
KW_LIST['kwa'] = '''abstract default if private this do implements protected
...
KW_LIST['kwb'] = '''boolean double byte int short void char long float'''

KW_LIST['kwc'] = '''AWTError AWTEvent AWTEventListener AWTEventListenerProxy
