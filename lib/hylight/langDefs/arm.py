...
KW_LIST['kwa'] = '''AND and EOR eor SUB sub RSB rsb ADD add ADC adc SBC sbc RSC rsc TST
...
KW_LIST['kwb'] = '''A1 A2 A3 A4 F0 F1 F2 F3 F4 F5 F6 F7 FP IP LR PC R0 R1 R10 R11 R12 R13
